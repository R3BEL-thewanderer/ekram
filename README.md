...
> This website is a **Gen-AI Native** project, built entirely using advanced AI models:
> *   **Research & MVP Prompts:** Powered by **Perplexity AI**.
> *   **Code Generation, Model Preparation & Architecture:** Engineered by **Antigravity Gemini Pro 3**.
